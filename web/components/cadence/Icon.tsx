// Cadence icon set — inline SVG glyphs ported VERBATIM from the design handoff (ui.jsx CIcons path
// table). One stroked path per named glyph at ~1.7 stroke weight; <Icon name="..."/> renders it.
// Shared by the shell + all Operate pages (and reused by U16 Improve). No icon library dependency —
// keeps the bundle lean and the glyphs exactly matching the prototype.
import type { CSSProperties } from 'react';

export type IconName =
  | 'pulse' | 'broadcast' | 'list' | 'chart' | 'alert' | 'flask' | 'badge' | 'book' | 'branch'
  | 'mic' | 'spark' | 'pivot' | 'hand' | 'chevron' | 'chevDown' | 'chevUp' | 'shield' | 'search'
